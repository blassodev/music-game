...
"[project]/lib/hooks/use-audio-player.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function useAudioPlayer(audioUrl) {
    ...
    const [playback, setPlayback] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])({
        currentTime: 0,
        duration: 0,
        isPlaying: false
    });
        ...
        "useAudioPlayer.useEffect": ()=>{
            ...
            const handlePlay = {
                "useAudioPlayer.useEffect.handlePlay": ()=>{
                    setState("playing");
                    setPlayback({
                        "useAudioPlayer.useEffect.handlePlay": (prev)=>({
                                ...prev,
                                isPlaying: true
                            })
                    }["useAudioPlayer.useEffect.handlePlay"]);
            ...
            const handlePause = {
                "useAudioPlayer.useEffect.handlePause": ()=>{
                    setState("paused");
                    setPlayback({
                        "useAudioPlayer.useEffect.handlePause": (prev)=>({
                                ...prev,
                                isPlaying: false
                            })
                    }["useAudioPlayer.useEffect.handlePause"]);
    ...
    const play = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAudioPlayer.useCallback[play]": async ()=>{
            try {
                var _audioRef_current;
                await ((_audioRef_current = audioRef.current) === null || _audioRef_current === void 0 ? void 0 : _audioRef_current.play());
            } catch (e) {
                setState("error");
            }
        }
    ...
    const stop = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAudioPlayer.useCallback[stop]": ()=>{
            if (audioRef.current) {
    ...
    const forward10 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAudioPlayer.useCallback[forward10]": ()=>{
            if (audioRef.current) {
                audioRef.current.currentTime = Math.min(audioRef.current.currentTime + 10, audioRef.current.duration);
            }
        }
    }["useAudioPlayer.useCallback[forward10]"], []);
    const backward10 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAudioPlayer.useCallback[backward10]": ()=>{
            if (audioRef.current) {
...
_s(useAudioPlayer, "SRucTFVBtwe7/nERNpqKQTwElz0=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
"[project]/components/player/audio-player.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$audio$2d$player$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/hooks/use-audio-player.ts [app-client] (ecmascript)");
...
function AudioPlayer(param) {
    ...
    const { state, playback, play, pause, stop, forward10, backward10 } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$audio$2d$player$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAudioPlayer"])(audioUrl);
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
                                ...
                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                    ...
                                    children: [
                                        ...Array(5)
                                            ...
                                            className: "w-2 bg-primary rounded-full transition-all duration-300 ".concat(playback.isPlaying ? "animate-pulse" : ""),
                                            style: {
                                                height: playback.isPlaying ? "".concat(30 + Math.random() * 30, "px") : "20px",
                            ...
                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDuration"])(Math.floor(playback.currentTime))
                                    }, void 0, false, {
                                        fileName: "[project]/components/player/audio-player.tsx",
                                        lineNumber: 110,
                                        columnNumber: 15
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                        children: (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["formatDuration"])(Math.floor(playback.duration))
                                    }, void 0, false, {
                                        fileName: "[project]/components/player/audio-player.tsx",
                                        lineNumber: 111,
                                        columnNumber: 15
...
_s(AudioPlayer, "lBrhqq0bRiy6CMeLbp2b5CFH3no=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$navigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useRouter"],
        __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$hooks$2f$use$2d$audio$2d$player$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAudioPlayer"]
    ];
});
_c = AudioPlayer;
var _c;
...
//# sourceMappingURL=_a5c63cd9._.js.map