...
"[project]/components/scanner/qr-scanner.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function QRScanner() {
    ...
    const [hasFlash, setHasFlash] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])(false);
    ...
    const startScanning = async ()=>{
        try {
            ...
            const devices = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$html5$2d$qrcode$2f$esm$2f$html5$2d$qrcode$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Html5Qrcode"].getCameras();
            ...
            await scanner.start(cameraId, {
                ...
                if ((0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$mock$2d$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["validateCardCode"])(decodedText)) {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Card scanned successfully!");
                    scanner.stop();
                    router.push(`/player/${decodedText}`);
                } else {
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Invalid card code");
                }
            }, ()=>{});
            try {
    ...
    const toggleFlash = async ()=>{
        if (scannerRef.current?.isScanning) {
            try {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].error("Failed to toggle flash");
            }
        }
    };
    const simulateScan = ()=>{
        const testCode = "CARD-ROCK-001-A1B2";
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["toast"].success("Test scan successful!");
...
//# sourceMappingURL=_adc44e33._.js.map